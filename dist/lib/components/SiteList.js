...
var SiteList = /** @class */ (function (_super) {
    ...
    SiteList.prototype.render = function () {
        ...
        if (!sites || (sites && sites.length === 0)) {
            return (react_1.default.createElement("div", { className: GithubActionsWidget_css_1.default.error }, "No sites are defined in the widget options. Please check your config."));
        }
        return (react_1.default.createElement("ul", { className: GithubActionsWidget_css_1.default.sites }, sites.map(function (site, index) {
