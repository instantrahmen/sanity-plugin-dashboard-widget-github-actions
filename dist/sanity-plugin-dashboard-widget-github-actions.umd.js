(function (global, factory) {
    ...
    (global.sanityPluginDashboardWidgetGithubActions = factory(global.reactDom));
    ...
    */
    ...
    function streamingComponent(observableOrFactory) {
        return class StreamingComponent extends undefined {
            constructor(props) {
                super(props);
    ...
    function deploy(site) {
        ...
        return statusCodeRequest("https://api.github.com/repos/" + site.githubRepoOwner + "/" + site.githubRepo + "/dispatches", {
    ...
    var props$ = function (options) {
        ...
        var _a = createEventHandler(), onDeploy$ = _a[0], onDeploy = _a[1];
        var setSitesAction$ = of(sites).pipe(map(function (sites) { return ({ type: 'setSites', sites: sites }); }));
        var deployAction$ = onDeploy$.pipe(map(function (site) { return ({ type: 'deploy/started', site: site }); }));
        var deployResult$ = onDeploy$.pipe(switchMap(function (site) { return deploy(site); }));
        var deployCompletedAction$ = deployResult$.pipe(map(function (result) { return (__assign({ type: 'deploy/completed' }, result)); }, catchError(function (error) { return of({ type: 'deploy/failed', error: error }); })));
        merge(setSitesAction$, deployAction$, deployCompletedAction$)
            .pipe(stateReducer$)
            .subscribe();
        return of(sites).pipe(map(function (sites) {
            return {
                sites: sites,
    ...
    var css_248z = ":import(\"part:@sanity/dashboard/widget-styles\"){\n  i__imported_container_0: container;\n  i__imported_header_1: header;\n  i__imported_title_2: title;\n  i__imported_footer_3: footer;\n}\n\n@import 'part:@sanity/base/theme/variables-style';\n\n.GithubActionsWidget_container__24sBN {\n}\n\n.GithubActionsWidget_description__2UM7B {\n  padding: var(--small-padding) var(--medium-padding) var(--medium-padding);\n  margin: 0;\n}\n\n.GithubActionsWidget_header__N5dp7 {\n}\n\n.GithubActionsWidget_title__3wbXy {\n}\n\n.GithubActionsWidget_error__3DIu1 {\n  color: var(--state-danger-color);\n  padding: var(--medium-padding);\n}\n\n.GithubActionsWidget_content__36JK9 {\n  position: relative;\n  padding: var(--small-padding) 0;\n  border-top: 1px solid var(--hairline-color);\n  min-height: 66px;\n}\n\n.GithubActionsWidget_sites__27Efe {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n}\n\n.GithubActionsWidget_footer__1Q6fo {\n  border-top: 1px solid var(--hairline-color);\n}\n";
    var styles = {"container":"GithubActionsWidget_container__24sBN i__imported_container_0","description":"GithubActionsWidget_description__2UM7B","header":"GithubActionsWidget_header__N5dp7 i__imported_header_1","title":"GithubActionsWidget_title__3wbXy i__imported_title_2","error":"GithubActionsWidget_error__3DIu1","content":"GithubActionsWidget_content__36JK9","sites":"GithubActionsWidget_sites__27Efe","footer":"GithubActionsWidget_footer__1Q6fo i__imported_footer_3"};
    ...
    var css_248z$1 = ".Portal_captureTabFocus__1Hiq9 {\n  position: absolute;\n  height: 0;\n  width: 0;\n}\n";
    var Portal$1 = {"captureTabFocus":"Portal_captureTabFocus__1Hiq9"};
    var stylesheet$1=".Portal_captureTabFocus__1Hiq9 {\n  position: absolute;\n  height: 0;\n  width: 0;\n}\n";
    styleInject(css_248z$1);

    var Portal$2 = /*#__PURE__*/Object.freeze({
        captureTabFocus: captureTabFocus,
        default: Portal$1,
        stylesheet: stylesheet$1
    });

    var require$$2 = getCjsExportFromNamespace(Portal$2);
    ...
    var Portal$4 = createCommonjsModule(function (module, exports) {
    ...
    class Spinner extends _react.default.PureComponent {
      ...
      render() {
        ...
        return fullscreen ? _react.default.createElement(Portal$4.Portal, null, this.renderSpinner()) : this.renderSpinner();
      }
    ...
    */
    ...
    var _defaultStyle = _interopRequireDefault(styleMock);
    ...
    var DefaultButton$1 = unwrapExports(DefaultButton);

    var css_248z$2 = "@import 'part:@sanity/base/theme/variables-style';\n\n.SiteItem_root__2Ie7Q {\n  display: flex;\n}\n\n.SiteItem_status__3WrR4 {\n  flex: 1;\n  padding: var(--small-padding) var(--medium-padding) var(--small-padding) var(--medium-padding);\n}\n\n.SiteItem_error__10LsT {\n  color: var(--state-danger-color);\n}\n\n.SiteItem_title__3yWR2 {\n  font-weight: 400;\n  line-height: 1.3em;\n  margin: 0 0 calc(var(--small-padding) / 2);\n}\n\n.SiteItem_actions__Qm4JE {\n  padding: var(--small-padding) var(--medium-padding);\n  display: flex;\n}\n";
    ...
    var SiteItem = /** @class */ (function (_super) {
        ...
        SiteItem.prototype.renderLinks = function () {
            ...
            return (react.createElement(react.Fragment, null,
                ' (',
                site.url && (react.createElement("span", null,
                    react.createElement("a", { href: site.url, target: 'blank' }, "view"))),
                ')'));
        };
        SiteItem.prototype.render = function () {
            var site = this.props.site;
            return (react.createElement("li", { className: styles$1.root },
                react.createElement("div", { className: styles$1.status },
                    react.createElement("h4", { className: styles$1.title },
                        site.title,
                        this.renderLinks()),
                    react.createElement("div", null)),
                react.createElement("div", { className: styles$1.actions },
                    react.createElement(DefaultButton$1, { inverted: true, onClick: this.handleDeployButtonClicked }, "Deploy"))));
        };
        return SiteItem;
    }(react.Component));
    ...
    var SiteList = /** @class */ (function (_super) {
        ...
        SiteList.prototype.render = function () {
            var _a = this.props, isLoading = _a.isLoading, onDeploy = _a.onDeploy, sites$$1 = _a.sites;
            if (isLoading) {
                return react.createElement(Spinner, { center: true, message: "Loading sites\u2026" });
            }
            if (!sites$$1 || (sites$$1 && sites$$1.length === 0)) {
                return (react.createElement("div", { className: styles.error }, "No sites are defined in the widget options. Please check your config."));
            }
            return (react.createElement("ul", { className: styles.sites }, sites$$1.map(function (site, index) {
                return (react.createElement(SiteItem, { onDeploy: onDeploy, site: site, key: "site-" + index }));
            })));
        };
        return SiteList;
    }(react.Component));
    ...
    var GithubActionsWidget = /** @class */ (function (_super) {
        ...
        GithubActionsWidget.prototype.render = function () {
            var _a = this.props, title$$1 = _a.title, description$$1 = _a.description, isLoading = _a.isLoading, sites$$1 = _a.sites, onDeploy = _a.onDeploy;
            console.log('this.props', this.props);
            return (react.createElement("div", { className: styles.container },
                react.createElement("header", { className: styles.header },
                    react.createElement("h2", { className: styles.title }, title$$1)),
                react.createElement("div", { className: styles.content },
                    description$$1 && (react.createElement("p", { className: styles.description, dangerouslySetInnerHTML: { __html: description$$1 } })),
                    react.createElement(SiteList, { isLoading: isLoading, onDeploy: onDeploy, sites: sites$$1 }))));
        };
        return GithubActionsWidget;
    }(react.Component));

    var Widget = streamingComponent(function (options$) {
        return options$.pipe(switchMap(function (options) {
            return props$(options).pipe(map(function (props) {
                return react.createElement(GithubActionsWidget, __assign({}, props));
            }));
        }));
    });
...
//# sourceMappingURL=sanity-plugin-dashboard-widget-github-actions.umd.js.map
